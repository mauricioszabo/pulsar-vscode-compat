...
function _initShims() {
  ...
  try { require('./shims/node-event-target').install(); } catch (e) { console.error('[vscode-compat] node event-target shim init:', e); }
}
...
module.exports = {
  ...
  provideHover() {
    return require('./namespaces/languages').provideHover();
  },

  provideOutlines() {
    return require('./namespaces/window').provideOutlines();
  },

  provideFindReferences() {
    return require('./namespaces/languages').provideFindReferences();
  },
};
