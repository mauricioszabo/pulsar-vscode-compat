...
// Callouts for lines other than the cursor's fade way back so a screen full of hints stays
// readable; the cursor line's callout keeps full emphasis.
function setInlayHintCalloutEmphasis(element, emphasized) {
  element.style.opacity = emphasized ? '0.95' : '0.90';
}
